...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Новогодние подарки оптом для бизнеса 2026–2027 — сладкие наборы с завода | Подаркинг" },
      {
        name: "description",
        content:
          "Корпоративные новогодние подарки оптом напрямую с кондитерских заводов России и Беларуси. Наборы для сотрудников, детей, партнёров и VIP. Брендирование, договор с НДС, доставка по РФ. От 420 ₽ за набор.",
      },
      { property: "og:title", content: "Новогодние подарки оптом для бизнеса 2026–2027 — сладкие наборы с завода" },
      {
        property: "og:description",
        content:
          "Сладкие корпоративные подарки напрямую с заводов: сотрудникам, детям, партнёрам. Брендирование, договор с НДС, доставка по РФ. От 420 ₽ за набор.",
      },
      { property: "og:url", content: "https://podarking.lovable.app/" },
    ],
    links: [{ rel: "canonical", href: "https://podarking.lovable.app/" }],
  }),
  component: Index,
});
