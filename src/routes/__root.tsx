...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Сладкие новогодние подарки оптом для бизнеса" },
      {
        name: "description",
        content:
          "Корпоративные новогодние подарки оптом: сладкие наборы с заводов России и Беларуси. Брендирование, доставка по РФ, договор для юрлиц.",
      },
      { name: "author", content: "Новогодние Подарки" },
      { property: "og:title", content: "Сладкие новогодние подарки оптом для бизнеса" },
      {
        property: "og:description",
        content:
          "Корпоративные новогодние подарки оптом: сладкие наборы с заводов России и Беларуси. Брендирование, доставка по РФ.",
      },
